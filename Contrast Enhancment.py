...
image = cv2.imread("riram.jpg", cv2.IMREAD_GRAYSCALE)  # Membaca citra "riram.jpg" dalam mode grayscale
...
output1 = np.empty([m1, n1])  # Membuat array kosong untuk menyimpan output
